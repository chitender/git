...
public class Form extends JFrame {
	...
	public Form(){
		...
		l1 = new JLabel("ENTER ADMIN DETAILS", JLabel.CENTER);
		l1.setForeground(Color.blue);
        l1.setFont(new Font("Serif", Font.BOLD, 20));
		l2 = new JLabel("Admin MSISDN", JLabel.LEFT);
		tf1 = new JTextField(10);
		l3 = new JLabel("Admin Name",JLabel.LEFT);
		tf2 = new JTextField(10);
		l4 = new JLabel("Company Name",JLabel.LEFT);
		tf3 = new JTextField(10);
		l5 = new JLabel("COCP/COIP",JLabel.LEFT);
		tf4 = new JTextField(10);
		l6 = new JLabel("Circle Code",JLabel.LEFT);
		tf5 = new JTextField(10);
		l7 = new JLabel("Campaign Id",JLabel.LEFT);
		tf6 = new JTextField(10);
		l8 = new JLabel("Email ID",JLabel.LEFT);
		tf7 = new JTextField(10);
		l9 = new JLabel("Agent Code",JLabel.LEFT);
		tf8 = new JTextField(10);
		l10 = new JLabel("Sub Agent Code",JLabel.LEFT);
